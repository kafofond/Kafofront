...
@Component({
  ...
  styleUrl: './contentbody-listbudget-respo.css',
})
export class ContentbodyListbudgetRespo {
  budgets: BudgetItem[] = [
    { id: 1,
    ...
    { id: 3,
      ...
      description:
        "Budget destiné aux programmes de formation et développement des compétences pour l'année 2024.",
    ...
    { id: 4,
      ...
      description:
        "Budget pour la recherche et le développement de nouveaux produits pour l'année 2024.",
      montantBudget: 60000,
  ...
  openEditBudgetModal(budget: BudgetItem): void {
    ...
    this.editFormData = {
      ...
      dateDeDebut: budget.dateDeDebut
        ? new Date(budget.dateDeDebut).toISOString().substring(0, 10)
        : '',
