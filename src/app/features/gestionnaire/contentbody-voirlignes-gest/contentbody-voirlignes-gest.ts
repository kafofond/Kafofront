...
@Component({
  ...
  templateUrl: './contentbody-voirlignes-gest.html',
  styleUrls: ['./contentbody-voirlignes-gest.css']
})
export class ContentbodyVoirlignesGest implements OnInit, OnDestroy {
  ...
  private handleRoutingError(): void {
    ...
    setTimeout(() => {
      this.router.navigate(['/gestionnaire/listbudget-gestionnaire']);
    }, 3000);
  }
