...
@Component({
  selector: 'app-navbar-dsi',
  imports: [CommonModule, NotificationComponent],
  templateUrl: './navbar-dsi.html',
  styleUrl: './navbar-dsi.css'
})
export class NavbarDsi implements OnInit {
  ...
  private routeTitles: { [key: string]: { title: string, breadcrumb: string } } = {
    'dsi': { title: 'Tableau de bord', breadcrumb: 'Vue d\'ensemble' },
    'dsi/utilisateurs-dsi': { title: 'Gestion des utilisateurs', breadcrumb: 'Liste des utilisateurs' },
    'dsi/historiques-dsi': { title: 'Historiques des actions', breadcrumb: 'Journal d\'activité' },
    'dsi/parametres-dsi': { title: 'Paramètres', breadcrumb: 'Configuration' }
  };
  ...
  private getRoleText(role: string): string {
    return role === 'ADMIN' ? 'Administrateur' : 'Administrateur';
  }
